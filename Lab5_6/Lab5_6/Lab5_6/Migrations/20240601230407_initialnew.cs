        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateOfAdmittance = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("cc066571-162b-4c8b-b912-9394e7639c43"), new DateTime(2024, 4, 14, 22, 0, 0, 0, DateTimeKind.Utc), new DateTime(1999, 12, 31, 23, 0, 0, 0, DateTimeKind.Utc), new DateTime(2024, 4, 18, 22, 0, 0, 0, DateTimeKind.Utc), new Guid("84aff43b-017c-421e-846b-9b55ba1dc61d"), "Ivo", true, "Ivic", 1, 0, "222222222", "22222222222" },
                    { new Guid("cc3835ad-5937-4426-b8e3-8a1d0a27a495"), new DateTime(2024, 4, 19, 22, 0, 0, 0, DateTimeKind.Utc), new DateTime(2002, 10, 14, 22, 0, 0, 0, DateTimeKind.Utc), new DateTime(2024, 4, 24, 22, 0, 0, 0, DateTimeKind.Utc), new Guid("8abf961e-67e5-4c66-82cd-804e521f7e68"), "Petar", true, "Topić", 1, 1, "111111111", "11111111111" }
                });
